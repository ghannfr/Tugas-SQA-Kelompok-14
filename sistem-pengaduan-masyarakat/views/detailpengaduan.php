...
<body>
    <?php 
     ...
     require '../controller/Pintasan.php';
        ...
        $hasiltanggapan = $proses->tampil_data_tanggapan('t_tanggapan','id_pengaduan',$idGet);
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Status Pengaduan</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <!-- General Form Elements -->
                    ...
                    <input type="hidden" class="form-control" id="id_pengaduan" name="id_pengaduan" value="<?php echo $hasil['id_pengaduan'] ?>">
                    <!--<input type="text" class="form-control" id="id_tanggapan" name="id_tanggapan" value="<?php echo $hasiltanggapan['id_user'] ?>">-->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="tanggapan" style="height: 100px" disabled><?php echo ($hasiltanggapan) ? $hasiltanggapan['tanggapan'] : 'Belum ada tanggapan.'; ?></textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <a href="statuspengaduan.php" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                    </div>
                </div>
